...
print ('###########')
print(f'{'win11-pc':>10s} {'192.111.111.111':>15s} {'2C-AB-44-11-22-5b'.upper():>17s} {11000:<7d} {'win11'.lower():>5s}')
print(f'{'win7':>10s} {'0.0.0.0':>15s} {'ab-ab-44-11-22-5b'.upper():>17s} {1:<7d} {'WIN7'.lower():>5s}')
